        ...
        <?php if (!isset($_SESSION['user'])) { ?>
            <div class="row new-account-login">
                <div class="col-sm-6 col-lg-6 mb-3">
                    ...
                    <form action="index.php?action=sign-in-user" method="post" class="mt-3 collapse review-form-box" id="formLogin">
                        <div class="form-row">
                ...
                <div class="col-sm-6 col-lg-6 mb-3">
                    ...
                    <form action="index.php?action=register-new-user" method="post" class="mt-3 collapse review-form-box" id="formRegister">
                        <div class="form-row">
                            <div class="form-group col-md-6">
